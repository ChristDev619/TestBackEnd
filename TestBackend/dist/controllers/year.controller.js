...
// SERVICES
var year_services_1 = require("../services/year.services");
var getYears = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var yearList, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, year_services_1.readYears)()];
            case 1:
                yearList = _a.sent();
                return [2 /*return*/, res.status(200).json(yearList)];
            case 2:
                error_1 = _a.sent();
