...
// READ User
var readUser = function (email) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_server_1.prisma.user.findUnique({
                    where: {
                        email: email,
                    },
                })];
...
var createUser = function (newUser) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_server_1.prisma.user.create({
                    data: {
                        email: newUser.email,
                        isEmployee: false,
...
// UPDATE User
var updateUser = function (newUser) { return __awaiter(void 0, void 0, void 0, function () {
    var existingEntry;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_server_1.prisma.user.findUnique({
            ...
            case 1:
                ...
                return [4 /*yield*/, db_server_1.prisma.user.update({
                        where: {
            ...
            case 3: return [4 /*yield*/, (0, exports.createUser)(newUser)];
...
var deleteUser = function (email) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_server_1.prisma.user.delete({
                    where: {
                        email: email,
                    },
                })];
