...
var requireAuth = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var authorization, accessToken, command, user, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                authorization = req.headers.authorization;
                if (!authorization) {
                    return [2 /*return*/, res.status(401).json({ error: "Auth token required." })];
                }
            ...
            case 2:
                // Verify access token validity
                _a.sent();
                command = new client_cognito_identity_provider_1.GetUserCommand({
                    AccessToken: accessToken,
                });
                user = aws_client_1.cognitoClient.send(command);
                req.user = user;
                next();
                return [3 /*break*/, 4];
            case 3:
