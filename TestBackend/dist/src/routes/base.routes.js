...
const YearController = __importStar(require("../controllers/year.controller"));
const DiscoverySourceController = __importStar(require("../controllers/discoverySource.controller"));
